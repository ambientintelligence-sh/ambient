...
function focusGroupControl(container: HTMLElement | null) {
  container
    ?.querySelector<HTMLElement>(
      "[data-slot='input-group-control'], input, textarea, [contenteditable='true']"
    )
    ?.focus()
}
...
function isInteractiveTarget(target: EventTarget | null) {
  ...
  return !!target.closest(
    "button, a, input, textarea, select, option, summary, [role='button'], [role='link']"
  )
}
  ...
  return (
    <div
      ...
      onClick={(e) => {
        ...
        focusGroupControl(e.currentTarget)
      }}
      {...props}
    />
  )
  ...
  return (
    <div
      ...
      onClick={(e) => {
        ...
        focusGroupControl(e.currentTarget.parentElement)
      }}
      {...props}
    />
  )
