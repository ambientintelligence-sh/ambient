...
export const PromptInput = ({
  ...
  // Stable ref for `add` so drag-and-drop effects don't re-register listeners
  ...
  const inner = (
    <>
      ...
      <form
        ...
        {...props}
      >
        <InputGroup className="overflow-hidden rounded-sm border-border/70 bg-background/60">
          {children}
        </InputGroup>
      </form>
    </>
